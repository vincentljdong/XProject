package com.jaydon.rxretrofit.util;
...
import com.jaydon.rxretrofit.request.RxRetrofitRequestBody;
...
public class Utils {
    ...
    @NonNull
    public static RxRetrofitRequestBody createNovateRequestBody(RequestBody requestBody, UpLoadCallback callback) {
        return new RxRetrofitRequestBody(requestBody, callback);
    }
